...
- Required Python packages (pip install -r requirements.txt):
  ...
  - pygame
  - tqdm 
- download and unzip models folder and put it in reversi-game/reversi-game folder - [Link to g drive](https://drive.google.com/drive/folders/14qqvrT65f06vb5iivH9EdJtylYMtIpWh?usp=sharing). The folder should be named "models".
