...
class BasicEnv(gym.Env):
    def __init__(self, use_cnn=False):
        ...
        self.last_move_should_be_other_agent = False
    ...
    def self_play(self):
        if self.game.turn == 60:  # play last move as agent to get reward win/loss/draw
            self.last_move_should_be_other_agent = True
            return
...
class CustomCallback(callbacks_module.BaseCallback):
